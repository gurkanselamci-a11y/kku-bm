...
export default async function scheduleView() {
  ...
  return {
    ...
    html: `<div class="stack">
      ...
      <div class="card">
        <b class="small">Not</b>
        <p class="tiny muted" style="margin:6px 0 0">Hazır gelen saatler bölümün yayımladığı ${escHtml(cur.academicYear)} Güz
        programından alındı; dönem içinde değişebilir. Kesin bilgi için
        <a href="https://bm.kku.edu.tr" target="_blank" rel="noopener">bm.kku.edu.tr</a> sayfasına bak.</p>
      </div>
    </div>`,
  };
}
